...
public class IOTCAPIs {
	...
	* Please see IOTCConnectionMode for possible modes. */
    ...
    public static final int IOTC_MAX_PACKET_SIZE = 1388;
	//IOTCApis interface
	public native static int  IOTC_Get_Login_Info(int[] LoginInfo);
	@Deprecated public native static void IOTC_Get_Version(int[] Version);
	public native static String IOTC_Get_Version_String();
	public native static int IOTC_Set_Max_Session_Number(int num);
	...
	@Deprecated public native static int  IOTC_Device_Login(String UID, String DeviceName, String DevicePWD);
	...
	public native static int IOTC_Check_Device_OnlineEx(String UID, St_IOTCCheckDeviceInput input, St_IOTCCheckDeviceOutput output, int timeout_ms, int[] abort);
    ...
    @Deprecated public native static int IOTC_Set_Master_Region(Region region);
	public native static int IOTC_GlobalLock_Lock();
	public native static int IOTC_GlobalLock_Unlock();
